...
class AtelierController extends Controller
{
	...
	{
		$profile = AtelierPage::with(['media', 'desktopMedia', 'mobileMedia'])->where('slug', 'profile')->first();
		return view('pages.atelier.profile', compact('profile'));
	}

	public function team()
	{
		$page = AtelierPage::with(['media', 'desktopMedia', 'mobileMedia'])->where('slug', 'team')->first();
	...
	{
		$page = AtelierPage::with(['media', 'desktopMedia', 'mobileMedia'])->where('slug', 'jobs')->first();
