<header 
  class="bg-white sticky top-0 z-40 md:relative border-b border-b-black w-full h-[var(--header-height-md)] xl:h-[var(--header-height-lg)] px-16 xl:px-32 pt-16 xl:pt-21 shrink-0 transition-[transform,margin] duration-600 ease-out will-change-transform [&.is-hidden]:-translate-y-full [&.is-hidden]:-mb-[var(--header-height-md)] motion-reduce:transition-none motion-reduce:[&.is-hidden]:translate-y-0 motion-reduce:[&.is-hidden]:mb-0"
  data-shy>
  <x-grid.container>
